...
int main(void)
{
	...
	while(choice != 99)
	{
		...
		switch(choice)
		{
			...
			case 17: // Last edited on 4/18/18
			{
					while(choice != 99)
					{
										...
										{	
											...
											if(strcmp(answer, "gp") == 0 || strcmp(answer, "GP") == 0)
											{
												...
												if(strcmp(answer, "Gangplank") == 0 || strcmp(answer, "gangplank") == 0)
												{
													...
													fclose(inptr);
													puts("Wow. You sure know your stuff. Congratulations. I'll let you out.");
													puts("Turns out this old dude was a wizard and he opens up a portal. You decide to walk through it.");
